      ...
      navigation.reset({
       ...
       if (error.code === 'auth/requires-recent-login') {
         Alert.alert(
          ...
          Alert.alert("Delete Account Error", `An error occurred: ${error.message}`);
       }
    } finally {
       setIsDeleting(false);
    }
  ...
  return (
    <SafeAreaView style={[styles.screenContainer, { backgroundColor: currentTheme.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
            ...
            {renderSettingRow(
               ...
               "Dark Mode",
                <Switch
                  ...
                  thumbColor={Platform.OS === 'android' ? currentTheme.primary : undefined} // Android thumb color
                  trackColor={{ false: "#767577", true: currentTheme.primary + '70' }} // Use primary with opacity for track
        ...
        {/* == Section: Account == */}
        <View style={styles.section}>
            <Text style={[styles.sectionHeader, { color: currentTheme.textSecondary }]}>Account</Text>
             {renderSettingRow(
                "user",
                "Edit Profile",
                renderChevron(),
             ...
             {renderSettingRow(
                ...
                "Change Password",
                renderChevron(),
                () => Alert.alert("Coming Soon", "Change password functionality will be added later."), // Placeholder action
         ...
         <View style={styles.section}>
             ...
             {renderSettingRow(
                ...
                "Notifications",
                renderChevron(),
                 () => Alert.alert("Coming Soon", "Notification settings will be added later."), // Placeholder action
                 true, // isFirstInSection
                 true // isLastInSection
             )}
         </View>
         ...
         <View style={styles.section}>
             <Text style={[styles.sectionHeader, { color: currentTheme.textSecondary }]}>About & Support</Text>
             {renderSettingRow(
                 "help-circle",
                 "Help & Support",
                 renderChevron(),
             ...
             {renderSettingRow(
                 ...
                 "Privacy Policy",
                 renderChevron(),
                  () => Alert.alert("Coming Soon", "Privacy Policy link will be added later."), // Placeholder action
                  false
             )}
              {renderSettingRow(
                 "file-text",
                 "Terms of Service",
                 renderChevron(),
                  () => Alert.alert("Coming Soon", "Terms of Service link will be added later."), // Placeholder action
                  false, // isFirstInSection
                  true // isLastInSection
             )}
         </View>
         ...
         <View style={styles.section}>
            ...
            <TouchableOpacity
                ...
                style={[styles.actionButton, styles.logoutButton, { backgroundColor: currentTheme.cardBackground, borderColor: currentTheme.primary }]}
            >
                {isLoggingOut ? (
                     <ActivityIndicator size="small" color={currentTheme.primary} />
                ) : (
                     <>
                         <Feather name="log-out" size={20} color={currentTheme.primary} style={styles.actionIcon} />
            ...
            <TouchableOpacity
                ...
                disabled={isDeleting}
                style={[styles.actionButton, styles.deleteButton, { backgroundColor: cardBackgroundColor, borderColor: errorColor }]}
            >
                {isDeleting ? (
                     <ActivityIndicator size="small" color={errorColor} />
                ) : (
                     <>
                         <Feather name="trash-2" size={20} color={errorColor} style={styles.actionIcon} />
...
const styles = StyleSheet.create({
  ...
  settingRight: {
   ...
   // },
   switchStyle: { // If specific switch styling needed beyond props
