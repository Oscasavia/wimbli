...
import {
    View, Text, StyleSheet, Image, TouchableOpacity, ActivityIndicator, ScrollView, FlatList, Modal, Alert, Pressable
} from 'react-native';
...
export default function ProfileScreen() {
    ...
    const toggleSettingsMenu = () => setSettingsMenuVisible(!isSettingsMenuVisible);
    ...
    return (
        ...
        <SafeAreaView style={[styles.safeArea, { backgroundColor: 'transparent' }]}>
            ...
            >
                <Feather name="more-vertical" size={24} color={currentTheme.textPrimary} />
            </TouchableOpacity>
            ...
            >
                ...
                >
                    <View style={[styles.settingsMenuContainer]}>
                        ...
                        >
                             <Feather name="settings" size={18} color={currentTheme.textSecondary} style={styles.settingsMenuIcon} />
                            <Text style={[styles.settingsMenuItemText, { color: currentTheme.textPrimary }]}>Settings</Text>
                        </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    settingsMenuOverlay: { // Can reuse modalOverlay or make specific
        flex: 1,
