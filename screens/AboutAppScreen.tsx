    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.infoContainer}>
          ...
          >
            Wimbli helps you discover local events and connect with people who
            share your interests. Create events, join group chats, and explore
        ...
        {/* Copyright Notice */}
        <Text
          style={[styles.copyrightText, { color: currentTheme.textSecondary }]}
        >
...
const styles = StyleSheet.create({
  ...
  linkText: {
    // Style for potential links like Licenses or Website
    fontSize: 15,
    fontWeight: "500",
    textAlign: "center",
